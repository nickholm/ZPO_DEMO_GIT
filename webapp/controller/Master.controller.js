...
sap.ui.define([
		...
		"sap/ui/Device",
		"uk/co/abports/ZPO_DEMO/model/formatter"
	], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("uk.co.abports.ZPO_DEMO.controller.Master", {
			...
			onInit : function () {
				...
				this._oGroupFunctions = {
					Menge : function(oContext) {
						var iGrouper = oContext.getProperty('Menge'),
							key, text;
						if (iGrouper <= 20) {
							key = "LE20";
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Ebelp", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("uk.co.abports.ZPO_DEMO.view.ViewSettingsDialog", this);
